...
LFLAGS=-T $(ROOT_FOLDER)/bsp/tiva/linker.ld
ifneq ($(CI),true)
...
INCLUDES=-I$(ROOT_FOLDER)/bsp/tiva -I$(ROOT_FOLDER)/test_applications/scratch/tiva/$(APP)
#-I$(ROOT_FOLDER)/driver/headers 

SRCS=$(wildcard $(ROOT_FOLDER)/bsp/tiva/*.c)
#SRCS+=$(wildcard $(ROOT_FOLDER)/driver/sources/*.c)
SRCS+=$(wildcard $(ROOT_FOLDER)/test_applications/scratch/tiva/$(APP)/*.c)

LDFILES=$(wildcard $(ROOT_FOLDER)/bsp/tiva/*.ld)
